...
// this act as middleware to modify the query object and show a particular page such as top 5 cheap tours
...
exports.getAllTours = async (req, res) => {
  try {
    // EXECUTE QUERY // Refactor the query and returned a new query object after chaining all the methods
